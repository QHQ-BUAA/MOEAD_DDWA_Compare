...
def get_args(n,m,PT,MT,PS,PQ,ni,means_m=1):
    ...
    parser.add_argument('--Processing_Speed', default=PS, type=list, help='process speed select')
    parser.add_argument('--Processing_Quality', default=PQ, type=list, help='processing quality')
    parser.add_argument('--means_m', default=means_m, type=float, help='avaliable machine')

    # Params for Algorithms
    parser.add_argument('--pop_size', default=300, type=int, help='Population size of the genetic algorithm')
    parser.add_argument('--gene_size', default=300, type=int, help='generation size of the genetic algorithm')
